#!/bin/bash
#SBATCH --job-name=calcCov_curated
#SBATCH --nodes=1
#SBATCH --mem=150G
...
# set paths
ref_fa="/home/yshin/mendel-nas1/snake_genome_ass/G_ussuriensis_Chromo/final_assembly/curated/Gloydius_ussuriensis_AMNH_21010_curated_scaffold11_split.fa"
reads_fq="/home/yshin/mendel-nas1/snake_genome_ass/G_ussuriensis_Chromo/genome_cleanup/AMNH_21010_HiFi.fastq.gz"
out_dir="/home/yshin/mendel-nas1/snake_genome_ass/G_ussuriensis_Chromo/final_assembly/curated/final_cov"
...
| tee "${out_dir}/${prefix}.coverage_thresholds.txt"
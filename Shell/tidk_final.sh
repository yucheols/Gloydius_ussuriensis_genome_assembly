...
# set output dir
outdir="/home/yshin/mendel-nas1/snake_genome_ass/G_ussuriensis_Chromo/find_telomere/final"
mkdir -p ${outdir}
cd ${outdir}
...
echo "This is run on a final curated genome."
tidk search \
  --string TTAGGG \

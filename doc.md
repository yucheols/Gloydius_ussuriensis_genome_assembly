...
```
1. RNA mapping / StringTie / transcript evidence
2. funannotate predict
3. InterProScan on proteins predicted by funannotate predict
4. funannotate annotate
5. Final QC / manual curation
```
...
####  Run RNA mapping / StringTie / transcript evidence building + funannotate predict
...
# after this, run interproscan and run funannotate annotate to add functional annotations
```
